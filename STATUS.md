...
| DSI-панель / panel pipeline | **Не завершено** | Драйвер DSI есть, но `mdss_dsi0`/PHY и описание панели пока не доведены до подтверждённого вывода через саму DSI-панель |
