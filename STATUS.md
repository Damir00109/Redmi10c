...
| Display (DRM/DSI) | panel probes, `fb0` 720x1650, init cmds OK, post-CRTC DCS still times out | 75% |
...
| Display (DRM/DSI + panel) | инициализация панели OK, 0x51 1-байт в prepare; нужна проверка подсветки | 75% |
